...
@section('content')
    ...
    <section class="content">
        <form action="{{ route('admin.pages.update', $page) }}" method="POST" enctype="multipart/form-data" role="form">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group @errorClass('title')">
                                ...
                                <input type="text" id="title" name="title" value="{{ old('title', $page->title) }}" class="form-control" placeholder="Enter title">
                                @errorMessage('title')
                            </div>
                            <div class="form-group @errorClass('slug')">
                                <label for="slug">Slug</label>
                                <input type="text" id="slug" name="slug" value="{{ old('slug', $page->slug) }}" class="form-control" placeholder="Leave blank to generate automatically">
                                @errorMessage('slug')
                            </div>
                            <div class="form-group @errorClass('excerpt')">
                                <label for="excerpt">Excerpt</label>
                                <input type="text" id="excerpt" name="excerpt" value="{{ old('excerpt', $page->excerpt) }}" class="form-control" placeholder="Enter excerpt">
                            ...
                            <div class="form-group @errorClass('image')">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" name="image" class="custom-file-input" id="image" value="{{ old('image', $page->image) }}">
                                ...
                                <div class="card-body" style="padding-right: 0; padding-left: 0; padding-bottom: 0;">
                                    <div class="tab-content" id="page-contentContent">
                                        <div class="tab-pane fade show active" id="page-content-html" role="tabpanel" aria-labelledby="page-content-html-tab">
                                            <textarea name="code_html" class="form-control editor" data-mode="xml" rows="10" placeholder="Enter HTML ...">{{ $page->code_html }}</textarea>
                                        </div>
                                        <div class="tab-pane fade" id="page-content-css" role="tabpanel" aria-labelledby="page-content-css-tab">
                                            <textarea name="code_css" class="form-control editor" data-mode="css" rows="10" placeholder="Enter CSS ...">{{ $page->code_css }}</textarea>
                                        </div>
                                        <div class="tab-pane fade" id="page-content-js" role="tabpanel" aria-labelledby="page-content-js-tab">
                                            <textarea name="code_js" class="form-control editor" data-mode="javascript" rows="10" placeholder="Enter JavaScript ...">{{ $page->code_js }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <!-- /.card -->
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group @errorClass('is_featured')">
                                        ...
                                        <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                            <input type="checkbox" name="is_featured" value="1" class="custom-control-input" id="is_featured" {{ ! $page->is_featured ?: 'checked' }}>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group @errorClass('is_homepage')">
                                        ...
                                        <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                            <input type="checkbox" name="is_homepage" value="1" class="custom-control-input" id="is_homepage" {{ ! $page->is_homepage ?: 'checked' }}>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group @errorClass('is_private')">
                                        ...
                                        <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                            <input type="checkbox" name="is_private" value="1" class="custom-control-input" id="is_private" {{ ! $page->is_private ?: 'checked' }}>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group @errorClass('published_at')">
                                        ...
                                        <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                            <input type="checkbox" name="published_at" value="1" class="custom-control-input" id="published_at" {{ ! $page->published_at ?: 'checked' }}>
