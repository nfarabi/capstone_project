    ...
    <div class="card">
        <div class="card-body register-card-body">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="input-group mb-3">
                    <input id="last_name" type="text" class="form-control @error('last_name') is-invalid @enderror" name="last_name" value="{{ old('last_name') }}" placeholder="{{ __('Last Name') }}" autocomplete="last_name">
                    <div class="input-group-append">
                        <div class="input-group-text">
                            <span class="fas fa-user"></span>
                        </div>
                ...
                @endphp
                <div class="form-group @errorClass('role')">
                    <select id="role" name="role" class="form-control select2" data-placeholder="Select account type" style="width: 100%;" data-allow-clear="false">
                        <option></option>
